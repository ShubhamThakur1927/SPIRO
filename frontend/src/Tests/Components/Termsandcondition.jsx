...
function Termsandcondition() {
  return (
    <div className='space-y-8 '>
      <div className="max-w-2xl mx-auto p-6 bg-white shadow-lg rounded-2xl border border-gray-200 w-screen">
    ...
    <div className="max-w-3xl w-s mx-auto p-6 bg-gray-100 shadow-lg rounded-2xl border border-gray-300 flex flex-col md:flex-row gap-6">

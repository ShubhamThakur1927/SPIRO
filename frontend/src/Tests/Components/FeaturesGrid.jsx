...
const FeatureCard = ({ title, description }) => {
  return (
    <div className="bg-gray-200 p-6 shadow-md text-center w-64 h-40 flex flex-col justify-center items-center" style={{ clipPath: "polygon(25% 0%, 75% 0%, 100% 50%, 75% 100%, 25% 100%, 0% 50%)" }}>
...
const FeaturesGrid = () => {
  ...
  return (
    <div className="grid grid-cols-2 gap-4 max-w-3xl mx-auto mt-10">
